...
/****** Object:  StoredProcedure [dbo].[LoadData]    Script Date: 11/21/2016 2:55:27 PM ******/
SET ANSI_NULLS ON
GO
...
--------------------------------------------   
	...
	set @str='bcp  "select * from dbo.EvaluationEtudiant" queryout  E:\StudentSuccess\EvaluationEtudiant.txt  -T -f E:\StudentSuccess\EvaluationEtudiant.fmt'  
	exec xp_cmdshell @str
